...
[MNIST](https://github.com/singularitti/MNIST.jl).
...
version of MNIST, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/singularitti/MNIST.jl"
```
...
our [GitHub repository](https://github.com/singularitti/MNIST.jl)
for new releases.
Once we release a new version, you can update MNIST by typing
